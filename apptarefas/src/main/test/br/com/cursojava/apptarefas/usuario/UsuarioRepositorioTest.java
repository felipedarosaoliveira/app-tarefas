...
public class UsuarioRepositorioTest {
	...
	public void antesDeCadaTest() {
		...
		dao.inserir(new Usuario(null, "Usuario01", "user01@teste.com", "senha000", new Date(),new Date(), new Date(),
				StatusUsuario.ATIVO));
		dao.inserir(new Usuario(null, "Usuario02", "user02@teste.com", "senha000", new Date(),new Date(), new Date(),
				StatusUsuario.ATIVO));
